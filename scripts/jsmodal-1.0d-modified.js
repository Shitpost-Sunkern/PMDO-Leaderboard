...
var Modal = (function () {
        ...
        var method = {},
            ...
            modalInnerContainer = document.createElement('div'),
        ...
        modalInnerContainer.setAttribute('id', 'modal-inner');
        modalHeader.setAttribute('id', 'modal-header');
        modalContent.setAttribute('id', 'modal-content');
        modalClose.setAttribute('id', 'modal-close');
        modalHeader.appendChild(modalClose);
        modalInnerContainer.appendChild(modalHeader);
        modalInnerContainer.appendChild(modalContent);
        modalContainer.appendChild(modalInnerContainer);
